...
var file_inventory_inventory_proto_rawDesc = []byte{
	...
	0x0a, 0x70, 0x61, 0x67, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x32, 0xd1, 0x05, 0x0a, 0x10,
	...
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x42,
...
var file_inventory_inventory_proto_depIdxs = []int32{
	...
	5,  // 31: inventory.InventoryService.GetUsers:output_type -> inventory.UserListResponse
	8,  // 32: inventory.InventoryService.CreateInventory:output_type -> inventory.CreateInventoryResponse
	11, // 33: inventory.InventoryService.GetCategories:output_type -> inventory.AllCategoryResponse
	12, // 34: inventory.InventoryService.GetSubCategories:output_type -> inventory.AllSubCategoryResponse
	9,  // 35: inventory.InventoryService.GetCategory:output_type -> inventory.CategoryResponse
	12, // 36: inventory.InventoryService.GetCategorySubcategories:output_type -> inventory.AllSubCategoryResponse
	14, // 37: inventory.InventoryService.RateInventory:output_type -> inventory.InventoryRatingResponse
	16, // 38: inventory.InventoryService.RateUser:output_type -> inventory.UserRatingResponse
	17, // 39: inventory.InventoryService.GetInventoryByID:output_type -> inventory.InventoryResponseDetail
