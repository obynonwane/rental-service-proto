...
var file_inventory_inventory_proto_rawDesc = []byte{
	...
	0x32, 0xbb, 0x02, 0x0a, 0x10, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x65,
...
var file_inventory_inventory_proto_depIdxs = []int32{
	...
	1,  // 13: inventory.InventoryService.GetCategory:input_type -> inventory.ResourceId
	3,  // 14: inventory.InventoryService.GetUsers:output_type -> inventory.UserListResponse
	6,  // 15: inventory.InventoryService.CreateInventory:output_type -> inventory.CreateInventoryResponse
	9,  // 16: inventory.InventoryService.GetCategories:output_type -> inventory.AllCategoryResponse
	7,  // 17: inventory.InventoryService.GetCategory:output_type -> inventory.CategoryResponse
