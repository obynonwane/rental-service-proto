...
var file_inventory_inventory_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x48, 0x75, 0x6d, 0x61, 0x6e, 0x32, 0xb9, 0x04, 0x0a, 0x10, 0x49,
...
var file_inventory_inventory_proto_depIdxs = []int32{
	13, // 0: inventory.User.created_at:type_name -> google.protobuf.Timestamp
	13, // 1: inventory.User.updated_at:type_name -> google.protobuf.Timestamp
	...
	13, // 4: inventory.CategoryResponse.created_at:type_name -> google.protobuf.Timestamp
	13, // 5: inventory.CategoryResponse.updated_at:type_name -> google.protobuf.Timestamp
	13, // 6: inventory.SubCategoryResponse.created_at:type_name -> google.protobuf.Timestamp
	13, // 7: inventory.SubCategoryResponse.updated_at:type_name -> google.protobuf.Timestamp
	...
	13, // 10: inventory.InventoryRatingResponse.updated_at:type_name -> google.protobuf.Timestamp
	13, // 11: inventory.InventoryRatingResponse.created_at:type_name -> google.protobuf.Timestamp
	0,  // 12: inventory.InventoryService.GetUsers:input_type -> inventory.EmptyRequest
	5,  // 13: inventory.InventoryService.CreateInventory:input_type -> inventory.CreateInventoryRequest
	0,  // 14: inventory.InventoryService.GetCategories:input_type -> inventory.EmptyRequest
	0,  // 15: inventory.InventoryService.GetSubCategories:input_type -> inventory.EmptyRequest
	1,  // 16: inventory.InventoryService.GetCategory:input_type -> inventory.ResourceId
	1,  // 17: inventory.InventoryService.GetCategorySubcategories:input_type -> inventory.ResourceId
	11, // 18: inventory.InventoryService.RateInventory:input_type -> inventory.InventoryRatingRequest
	3,  // 19: inventory.InventoryService.GetUsers:output_type -> inventory.UserListResponse
	6,  // 20: inventory.InventoryService.CreateInventory:output_type -> inventory.CreateInventoryResponse
	9,  // 21: inventory.InventoryService.GetCategories:output_type -> inventory.AllCategoryResponse
	10, // 22: inventory.InventoryService.GetSubCategories:output_type -> inventory.AllSubCategoryResponse
	7,  // 23: inventory.InventoryService.GetCategory:output_type -> inventory.CategoryResponse
	10, // 24: inventory.InventoryService.GetCategorySubcategories:output_type -> inventory.AllSubCategoryResponse
	12, // 25: inventory.InventoryService.RateInventory:output_type -> inventory.InventoryRatingResponse
